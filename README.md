...
```sh
flowpipe pipeline run list_vault
```
...
- Pass in a value on the command line:
  ...
  ```shell
  flowpipe pipeline run list_vault --pipeline-arg access_token="eya32asW3f323saf32..."
  ```
